...
console.log(process.arch); // 프로세서 아키텍쳐 정보. arm, ia32 등의 값일 수도 있습니다
console.log(process.platform); // 운영체제 플랫폼 정보. linux나 darwin, freebsd등의 값일 수도 있습니ㅏㄷ.
...
// NODE_ENV=development node node.js/ch3/process.js
